...
set yosys_abc_clk_fast_period [expr $lr_synth_clk_fast_period - $lr_synth_abc_clk_fast_uprate]

if { $lr_synth_timing_run } {
  yosys "abc -liberty $lr_synth_cell_library_path -constr $lr_synth_abc_sdc_file_in -D $yosys_abc_clk_period"
  yosys "abc -liberty $lr_synth_cell_library_path -constr $lr_synth_abc_sdc_file_in -D $yosys_abc_clk_fast_period"
} else {
